...
- [x] **名校情节** (`skills/mindset/fixed/elite-complex.md`) - *2830字，substantial*
...
- [x] **学会独处** (`skills/mindset/mental/learn-to-be-alone.md`) - *2402字，substantial*
- [x] **焦虑与内耗** (`skills/mindset/mental/anxiety-impostor.md`) - *3027字，substantial*
...
- [x] **构建人际关系网** (`skills/communication/skills/network-of-relationships.md`) - *3787字，substantial*
- [x] **团队协作** (`skills/communication/teamwork/teamwork.md`) - *1593字，substantial*
- [x] **人际矛盾处理** (`skills/communication/skills/dealing-conflicts.md`) - *3328字，substantial*
...
#### 转专业指南 (1/1)
- [x] **泛计算机** (`ncu-exclusive/major-transfer/cs.md`) - *3085字，substantial*

#### 保研之路 (1/1)
- [x] **计算机科学与技术** (`ncu-exclusive/postgraduate-recommendation/cs.md`) - *2925字，substantial*

#### 考研经验 (0/1)
- [ ] **11408** (`ncu-exclusive/postgraduate-exam/cs.md`) - *14字，minimal*
...
- [ ] **新生军训** (`ncu-exclusive/campus-life/military-training.md`) - *0字，empty*
