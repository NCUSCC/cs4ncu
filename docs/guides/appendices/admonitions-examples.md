...
这些是 Material for MkDocs 官方支持的类型，但我们已经用自定义 CSS 重写了它们的样式。
...
这些是我们在 `03-admonitions.css` 中全新添加的自定义类型。
...
??? declaration "Collapsible Declaration"
    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla et euismod nulla. Curabitur feugiat, tortor non consequat finibus, justo purus auctor massa, nec semper lorem quam in massa.
...
??? author "Collapsible Author's Note"
    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla et euismod nulla. Curabitur feugiat, tortor non consequat finibus, justo purus auctor massa, nec semper lorem quam in massa.
...
这些是官方支持但我们没有在 CSS 中特别定义的类型，它们应该会回退到默认的 `note` 样式或者主题的基础样式。
